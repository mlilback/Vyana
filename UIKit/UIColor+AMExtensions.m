//
//  UIColor+AMExtensions.m
//
//  Created by Mark Lilback on 12/14/10.
//  Copyright 2010-11 Agile Monks, LLC. All rights reserved.
//

#import "UIColor+AMExtensions.h"

#define vendColor(r, g, b) static UIColor *ret; if (ret == nil) ret = [[UIColor colorWithRed:(CGFloat)r/(CGFloat)255.0 green:(CGFloat)g/(CGFloat)255.0 blue:(CGFloat)b/(CGFloat)255.0 alpha:(CGFloat)1.0] retain]; return ret
